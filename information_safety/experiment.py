...
def train_lightning(
    ...
    *,
    ...
    skip_training = (
        hasattr(algorithm, "dataset_handler")
        and getattr(algorithm.dataset_handler, "max_examples", None) == 0
    )
    if skip_training:
        logger.info("max_examples=0 — skipping trainer.fit, will only evaluate.")
    else:
