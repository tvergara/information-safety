...
from information_safety.utils.env_vars import NETWORK_DATASETS_DIR, SLURM_JOB_ID
from information_safety.utils.hydra_utils import get_outer_class
...
def get_target_of_config(
    ...
    if _cs is None:
        from information_safety.configs import cs as _cs
