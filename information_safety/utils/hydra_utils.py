...
def resolve_dictconfig(dict_config: DictConfig) -> Config:
    ...
    Returns a [`Config`][information_safety.configs.Config] object, which is a simple dataclass used to give
...
def instance_attr(
    *attributes: str,
    ...
    !!! note "This is very hacky"
        ...
        your information_safety if you intend do use this feature.
