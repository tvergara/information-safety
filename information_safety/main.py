...
import information_safety
from information_safety.configs import add_configs_to_hydra_store
...
def setup_logging(log_level: str, global_log_level: str = "WARNING") -> None:
    from information_safety.main import PROJECT_NAME
    ...
    information_safety_logger = logging.getLogger(PROJECT_NAME)
    information_safety_logger.setLevel(log_level.upper())
