...
class Config:
    ...
    For more info, see the [instantiate_algorithm][information_safety.main.instantiate_algorithm] function.
    """
    ...
    See the [MNISTDataModule][information_safety.datamodules.image_classification.mnist.MNISTDataModule] for an example.
    """
