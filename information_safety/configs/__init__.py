"""All the configuration classes for the information_safety."""

from hydra.core.config_store import ConfigStore
from omegaconf import OmegaConf

from information_safety.configs.config import Config
from information_safety.utils.env_vars import get_constant
...
def add_configs_to_hydra_store():
    from information_safety.utils.remote_launcher_plugin import RemoteSlurmQueueConf
