...
from information_safety.algorithms.lightning_module_tests import LightningModuleTests
from information_safety.configs import Config
...
from information_safety.utils.testutils import IN_GITHUB_CI, run_for_all_configs_of_type
...
class TestImageClassifier(LightningModuleTests[ImageClassifier]):
    ...
    - `algorithm_config` will take the value `"image_classifier"`
        - This is because there is an `image_classifier.yaml` config file in information_safety/configs/algorithms
