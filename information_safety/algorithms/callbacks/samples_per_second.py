...
from information_safety.utils.typing_utils import NestedMapping, is_sequence_of


class MeasureSamplesPerSecondCallback[
    BatchType: (torch.Tensor | tuple[torch.Tensor, ...] | NestedMapping[str, torch.Tensor])
](lightning.Callback):
