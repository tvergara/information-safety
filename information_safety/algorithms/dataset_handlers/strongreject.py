...
class StrongRejectHandler(BaseDatasetHandler):
    """Dataset handler for AdvBench training and StrongREJECT evaluation."""
    ...
    def get_val_dataset(self, tokenizer: PreTrainedTokenizerBase) -> Dataset:
        """Load StrongREJECT forbidden prompts for evaluation."""
    ...
    def validate_batch(
        ...
        """Generate completions and record per-example FLOPs via the strategy."""
