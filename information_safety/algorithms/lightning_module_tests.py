...
See the [information_safety.algorithms.image_classifier_test][] module for an example of how to use this.
"""
...
from information_safety.conftest import DEFAULT_SEED
from information_safety.experiment import instantiate_trainer
from information_safety.main import instantiate_algorithm, setup_logging
...
class LightningModuleTests(Generic[LightningModuleType], ABC):
    ...
    See the [information_safety.algorithms.image_classifier_test][] module for an example.
