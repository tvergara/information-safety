#!/bin/bash
# Sweep over max_examples on AdvBench for pretrained safety-trained models (Llama-2, Llama-3).
# Uses data strategy to measure bits via arithmetic coding, evaluates ASR on HarmBench.
# Also runs a baseline (0 bits) evaluation per model.
...
for MODEL_KEY in llama2 llama3; do
